...
La aplicación utiliza el SDK de Firebase para analíticas. Asegúrate de configurar las siguientes variables de entorno en tu archivo `.env` o en tu sistema de CI/CD:
